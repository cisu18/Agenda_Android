...
public class Pensamiento extends Activity implements OnClickListener {
	...
	private void mostrarNotBarra() {
		...
		// Agregando el icono, texto y momento para lanzar la notificaci贸n
		...
		CharSequence contentTitle = "Notificaci贸n en barra";
		CharSequence contentText = "Mensaje corto de la notificaci贸n";
	...
	public void onClick(View v) {
		...
		case R.id.txv_ir_evaluacion:
			...
			if (!Val.isEvaluated(getApplicationContext(),preferencias.getString("id", "0"))) {
				...
				Toast.makeText(this, "Usted ya realizo su evaluaci髇", Toast.LENGTH_SHORT).show();
			}
			break;
